...
# Load CSV
df = pd.read_csv("data/fig7_rocket_prefetch_slow_reformat.csv")
df2 = pd.read_csv("data/fig7_rocket_prefetch_reformat.csv")
...
plt.ylabel("Slowdown")
plt.title("Fig 7 Rocket w/ Prefetch Clock Gating")
#plt.legend(title="DB Organization")

# Show the plot
plt.savefig("image/fig7_rocket_prefetch_clock_gating.png")
