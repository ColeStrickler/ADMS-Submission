...
plt.title("Fig 7 Rocket Prefetch - Normalized Cache Lines Missed")
plt.legend(title="DB Organization")

# Save the plot
plt.savefig("image/fig7_rocket_prefetch_cache_lines_missed.png")
plt.close()
...
plt.title("Fig 7 Rocket Prefetch - Cache Lines Accessed")
plt.legend(title="DB Organization")

# Save the plot
plt.savefig("image/fig7_rocket_prefetch_cache_lines_accessed.png")
plt.close()