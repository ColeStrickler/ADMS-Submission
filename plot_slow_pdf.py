...
df2 = pd.read_csv("data/fig8_rocket_slow_2_reformat.csv")
df4 = pd.read_csv("data/fig8_rocket_slow_4_reformat.csv")
df6 = pd.read_csv("data/fig8_rocket_slow_6_reformat.csv")
df7 = pd.read_csv("data/fig8_rocket_slow_7_reformat.csv")
df8 = pd.read_csv("data/fig8_rocket_slow_8_reformat.csv")
df9 = pd.read_csv("data/fig8_rocket_slow_9_reformat.csv")
df10 = pd.read_csv("data/fig8_rocket_slow_10_reformat.csv")
#df11 = pd.read_csv("data/fig8_rocket_slow_11_reformat.csv")
...
plt.tight_layout()
out_file = "image/plot_slow_crop.pdf"
