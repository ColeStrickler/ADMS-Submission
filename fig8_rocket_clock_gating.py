...
# Load CSV
df = pd.read_csv("data/fig8_rocket_slow_reformat.csv")
df2 = pd.read_csv("data/fig8_rocket_reformat.csv")
...
plt.ylabel("Slowdown")
plt.title("Fig 8 Rocket Clock Gating")
#plt.legend(title="DB Organization")

# Show the plot
plt.savefig("image/fig8_rocket_clock_gating.png")
