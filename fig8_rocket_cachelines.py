...
plt.title("Fig 8 Rocket - Normalized Cache Lines Missed")
plt.legend(title="DB Organization")

# Save the plot
plt.savefig("image/fig8_rocket_cache_lines_missed.png")
plt.close()
...
plt.title("Fig 8 Rocket - Cache Lines Accessed")
plt.legend(title="DB Organization")

# Save the plot
plt.savefig("image/fig8_rocket_cache_lines_accessed.png")
plt.close()