...
# Load CSV
df = pd.read_csv("data/fig8_boom_prefetch_reformat.csv")
...
plt.title("Fig 8 Boom Prefetch - Normalized Cache Lines Missed")
plt.legend(title="DB Organization")

# Save the plot
plt.savefig("image/fig8_boom_prefetch_cache_lines_missed.png")
plt.close()
...
plt.title("Fig 8 Boom Prefetch- Cache Lines Accessed")
plt.legend(title="DB Organization")

# Save the plot
plt.savefig("image/fig8_boom_prefetch_cache_lines_accessed.png")
plt.close()